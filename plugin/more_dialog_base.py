...
# Form implementation generated from reading ui file 'GoogleMapsEngineConnector/plugin/more_dialog_base.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupBoxWms.setGeometry(QtCore.QRect(10, 310, 480, 100))
        self.groupBoxWms.setObjectName(_fromUtf8("groupBoxWms"))
        self.comboBoxFormat = QtGui.QComboBox(self.groupBoxWms)
        self.comboBoxFormat.setGeometry(QtCore.QRect(370, 30, 78, 30))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("Dialog", "Default Image Format for WMS Overlays", None, QtGui.QApplication.UnicodeUTF8))
